    ...
    <div class="content">
        <div class="container-fluid">
            <main class="container" id="ajuste">
                <div class="row">
                    <form id="formulario_registro" method="post" action="{{route('reprovarpessoa')}}">
                        @if ($pessoa->status != 0)
                            ...
                            <ul id="progress" class="progress-ajuste2">
                                @else
                                    ...
                                    <fieldset>
                                        ...
                                        @endif
                                        <div id="recusar_div">
                                            <h3 style="color: red">Motivo para Reavaliar</h3>
                                        ...
                                        @if(count($pessoa->anexos->anexoCursoTecnico) > 0)
                                            @foreach($pessoa->anexos->anexoCursoTecnico as $anexoTecnico)
                                                ...
                                                @if ($pessoa->status != 0)
                                                    ...
                                                    <input type="number" value="{{$anexoTecnico->pontuacaoTecnico->pontuacao}}" disabled/>
                                                @endif
                                        ...
                                        <fieldset>
                                            ...
                                            @if (count($pessoa->anexos->anexoEspecializacao) > 0)
                                                @foreach($pessoa->anexos->anexoEspecializacao as $anexoEspecializacao)
                                                    ...
                                                    @if ($pessoa->status != 0)
                                                        <strong>Pontuação: </strong>
                                                        <input type="number" value="{{$anexoEspecializacao->pontuacaoEspecializacao->pontuacao}}" disabled/>
                                                    @endif
                                                    <hr style="border-top: 2px solid;"/>
                                                @endforeach
                                                    <div id="recusar_div">
                                        ...
                                        <fieldset>
                                            ...
                                            @if (count($pessoa->anexos->anexoMestrado) > 0)
                                                @foreach($pessoa->anexos->anexoMestrado as $anexoMestrado)
                                                    ...
                                                    @if($pessoa->status != 0)
                                                        <strong>Pontuação: </strong>
                                                        <input type="number" value="{{$anexoMestrado->pontuacaoMestrado->pontuacao}}" disabled/>
                                                    @endif
                                                    <hr style="border-top: 2px solid;"/>
                                                @endforeach
                                                    <div id="recusar_div">
                                        ...
                                        <fieldset>
                                            ...
                                            @if (count($pessoa->anexos->anexoDoutorado) > 0)
                                                @foreach($pessoa->anexos->anexoDoutorado as $anexoDoutorado)
                                                    ...
                                                    @if ($pessoa->status != 0)
                                                        <strong>Pontuação: </strong>
                                                        <input type="number" value="{{$anexoDoutorado->pontuacaoDoutorado->pontuacao}}" disabled/>
                                                    @endif
                                                    <hr style="border-top: 2px solid;"/>
                                                @endforeach
                                                    <div id="recusar_div">
                                    ...
                                    <fieldset>
                                        ...
                                        @if (count($pessoa->anexos->anexoExperiencia) > 0)
                                            @foreach($pessoa->anexos->anexoExperiencia as $anexoExperiencia)
                                                ...
                                                <p>Data de Entrada: </p>
                                                <input type="date" value="{{$anexoExperiencia->data_entrada}}" disabled/>

                                                <p>Data de Saída: </p>
                                                <input type="date" value="{{$anexoExperiencia->data_saida}}" disabled/>
                                                ...
                                                @if ($pessoa->status != 0)
                                                    <strong>Pontuação: </strong>
                                                    <input type="number" value="{{$anexoExperiencia->pontuacaoExperiencia->pontuacao}}" disabled/>
                                                @endif
                                                <hr style="border-top: 2px solid;"/>
                                            @endforeach
                                                <div id="recusar_div">
                                        ...
                                        <a href="{{route('aprovarpessoa', $pessoa->id)}}"><input type="button" name="prev" style="width: auto;" class="acao" value="Aceitar Avaliacação"/></a>
                                        <input type="submit" name="prev" id="next" class="acao" value="Reavaliar"/>
                                        <input type="button" name="prev" id="prev" class="prev acao" value="Anterior"/>
                                    </fieldset>
                    </form>
                </div>
